...
let foodArray = ['pho', 'sushi', 'steak', 'chicken wings'];
...
console.log('Removed the last animal', removedFood);
...
foodArray.unshift('blue berry pancake');
